<template>
    <div>
        <div v-for="post in posts" :key="post.id">
            <card v-bind:comments="post.comments" v-bind:id="post.id" v-bind:title="post.title" v-bind:subTitle="post.subTitle" v-bind:text="post.text" v-bind:link="post.link"></card>
        </div>
    </div>
</template>
